<x-layout>
    <div class="py-8 max-w-4xl mx-auto">
        <div class="flex justify-between items-center">
            <a href="{{ route('idea.index') }}" class="flex items-center gap-x-2 text-sm font-medium"> <x-icons.arrow-back/>
                Back to Ideas</a>
        ...
        <div class="mt-8 space-y-6">
            ...
            <div class="mt-2 flex gap-x-3 items-center">
                ...
                <div class="text-muted-foreground text-sm">{{ $idea->updated_at->diffForHumans() }}</div>
            </div>
            <x-card class="mt-6">
